...
contract EventTickets {
    ...
    */
    ...
    event LogGetRefund(address refundAccount, uint ticketsRefunded);
    ...
    */
    function getBuyerTicketCount(address _ticketBuyer)
        public
        view
        returns (uint)
    {
        return myEvent.buyers[_ticketBuyer];
    }
    ...
    */
            ...
            onlyOwner()
        {
            ...
            uint amountTransferred = myEvent.sales * TICKET_PRICE;
            msg.sender.transfer(amountTransferred);
            emit LogEndSale(msg.sender, amountTransferred);
        }
}
